...
# Define propiedades (get y set) para los atributos (usando decoradore
# @property)
# Constructor __init__(self, nombre, edad, peso)
# Método de instancia saluda que muestre algo como “ Soy un anima
...
# property)
# Sobrescribe saluda para que muestre algo como:”Soy un mamifero
# llamado Kuma, tengo 5 años y mi gestación dura 100 días.”
# Subclase Ave
